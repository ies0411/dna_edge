...
# python val.py --cfg_file ./cfgs/custom_models/dsvt_deep_test.yaml --work_dir /mnt/nas-1/eslim/workspace/dna_edge/test/
# --ckpt /mnt/nas-1/eslim/workspace/dna_edge/dsvt_deep_2/ckpt/checkpoint_epoch_24.pth
